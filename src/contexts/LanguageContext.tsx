...
const translations = {
  en: {
    ...
    returnPeriod: "30-Day Return Period",
    returnPeriodDesc: "You have 30 days from the date of delivery to return any item for a full refund or exchange.",
  ...
  ar: {
    ...
    returnPeriod: "فترة إرجاع 30 يوماً",
    returnPeriodDesc: "لديك 30 يوماً من تاريخ التسليم لإرجاع أي منتج واسترداد المبلغ كاملاً أو استبداله.",
